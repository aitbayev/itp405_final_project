...
@section('content')
    ...
    <h2>{{$place->city_name}}</h2>
     ...
     <div class="instagram">
           Instagram posts with a hashtag #{{$place->city_name}}view
          <div class="instagram">
                    @foreach($instagrams as $instagram)
                  <a href="{{$instagram->images->standard_resolution->url}}" data-lightbox="instagram"><img src="{{$instagram->images->low_resolution->url}}"></a>
                    @endforeach
                </div>
</div>
    ...
    @endif
        ...
        @if(Auth::check())
            ...
            @else
                 <p> <a href="/search#login">Login</a> to write a review</p>
            @endif

                <div class="row">
                    <div class="col-md-8">
                        <div class="page-header">
                            <h1><small class="pull-right">{{sizeof($reviews)}} reviews</small> Reviews </h1>
                        </div>
                        <div class="comments-list">
                            @foreach($reviews as $review)
                                <div class="media">
                                    <div class="media-body">
                                        <h4 class="media-heading user_name">{{$review->name}}:</h4>
                                        {{$review->review}}
                                    </div>
                                </div>
                             @endforeach
